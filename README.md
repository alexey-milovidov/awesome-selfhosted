...
- [Pastila](https://github.com/ClickHouse/pastila) - minimalistic paste service: single page, zero click experience. ([Source Code](https://github.com/ClickHouse/pastila)) `Apache 2.0` `JS/ClickHouse`
